...
CREATE TABLE IF NOT EXISTS TUNNEL_DESKTOP_ (
    DEVICE_ID_ TEXT PRIMARY KEY,
    DEVICE_NAME_ TEXT NOT NULL,
    USERNAME_ TEXT,
    AGENT_TOKEN_BCRYPT_ TEXT NOT NULL,
    STATUS_ TEXT NOT NULL DEFAULT 'OFFLINE',
    ENABLED_ INTEGER NOT NULL DEFAULT 1,
    PUBLIC_HOST_ TEXT NOT NULL,
    PUBLIC_URL_ TEXT NOT NULL,
    WEB_SOCKET_URL_ TEXT NOT NULL,
    CURRENT_SESSION_ID_ TEXT,
    CONNECTED_AT_ TIMESTAMP,
    LAST_SEEN_AT_ TIMESTAMP,
    LAST_DISCONNECTED_AT_ TIMESTAMP,
    BYTES_IN_ INTEGER NOT NULL DEFAULT 0,
    BYTES_OUT_ INTEGER NOT NULL DEFAULT 0,
    CREATE_AT_ TIMESTAMP NOT NULL,
    UPDATE_AT_ TIMESTAMP NOT NULL
);

CREATE INDEX IF NOT EXISTS IDX_TUNNEL_DESKTOP_STATUS_ ON TUNNEL_DESKTOP_(STATUS_);
CREATE INDEX IF NOT EXISTS IDX_TUNNEL_DESKTOP_UPDATE_AT_ ON TUNNEL_DESKTOP_(UPDATE_AT_ DESC);

CREATE TABLE IF NOT EXISTS TUNNEL_WEBAPP_ (
    ROUTE_ID_ TEXT PRIMARY KEY,
    NAME_ TEXT NOT NULL,
    PUBLIC_HOST_ TEXT NOT NULL,
    PUBLIC_URL_ TEXT NOT NULL,
    UPSTREAM_URL_ TEXT NOT NULL,
    STATUS_ TEXT NOT NULL DEFAULT 'OFFLINE',
    ENABLED_ INTEGER NOT NULL DEFAULT 1,
    CONNECTIONS_ INTEGER NOT NULL DEFAULT 0,
    LAST_ACCESSED_AT_ TIMESTAMP,
    BYTES_IN_ INTEGER NOT NULL DEFAULT 0,
    BYTES_OUT_ INTEGER NOT NULL DEFAULT 0,
    CREATE_AT_ TIMESTAMP NOT NULL,
    UPDATE_AT_ TIMESTAMP NOT NULL
...
CREATE INDEX IF NOT EXISTS IDX_TUNNEL_WEBAPP_STATUS_ ON TUNNEL_WEBAPP_(STATUS_);
CREATE INDEX IF NOT EXISTS IDX_TUNNEL_WEBAPP_UPDATE_AT_ ON TUNNEL_WEBAPP_(UPDATE_AT_ DESC);

CREATE TABLE IF NOT EXISTS TUNNEL_ACTIVITY_ (
    ACTIVITY_ID_ TEXT PRIMARY KEY,
    OBJECT_TYPE_ TEXT NOT NULL,
    OBJECT_ID_ TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS IDX_TUNNEL_ACTIVITY_CREATE_AT_ ON TUNNEL_ACTIVITY_(CREATE_AT_ DESC);
CREATE INDEX IF NOT EXISTS IDX_TUNNEL_ACTIVITY_OBJECT_ ON TUNNEL_ACTIVITY_(OBJECT_TYPE_, OBJECT_ID_);

CREATE TABLE IF NOT EXISTS TUNNEL_TRAFFIC_BUCKET_ (
    BUCKET_START_ TIMESTAMP NOT NULL,
    BUCKET_KIND_ TEXT NOT NULL,
    OBJECT_ID_ TEXT NOT NULL,
    BYTES_IN_ INTEGER NOT NULL DEFAULT 0,
    BYTES_OUT_ INTEGER NOT NULL DEFAULT 0,
    REQUEST_COUNT_ INTEGER NOT NULL DEFAULT 0,
    PRIMARY KEY (BUCKET_START_, BUCKET_KIND_, OBJECT_ID_)
);

CREATE INDEX IF NOT EXISTS IDX_TUNNEL_TRAFFIC_BUCKET_START_ ON TUNNEL_TRAFFIC_BUCKET_(BUCKET_START_);
